...
class InsertionSortListTest {
    ...
    void insertionSortList() {
        ListNode initial = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[1 3 2 4]"));
    ...
    void insertionSortList2() {
        ListNode initial = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[4 3 2 1]"));
        ListNode expected = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[1 2 3 4]"));
        ListNode actual  = sol.insertionSortList(initial);
        assertTrue(ListNode.equals(expected, actual), errorMessage(expected, actual));
    }
    ...
    void insertionSortList3() {
        ListNode initial = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[3 2 5 4 7]"));
        ListNode expected = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[2 3 4 5 7]"));
        ListNode actual  = sol.insertionSortList(initial);
        assertTrue(ListNode.equals(expected, actual), errorMessage(expected, actual));
    }
    @Test
    void insertionSortList4() {
        ListNode initial = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[2 1 2 3 1 3 2]"));
        ListNode expected = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[1 1 2 2 2 3 3]"));
        ListNode actual  = sol.insertionSortList(initial);
        assertTrue(ListNode.equals(expected, actual), errorMessage(expected, actual));
    }
    @Test
    ...
    void insertionSortListCornerCase4() {
        ListNode initial  = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[2 1]"));
        ListNode expected = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[1 2]"));
        ListNode actual  = sol.insertionSortList(initial);
        assertTrue(ListNode.equals(expected, actual), errorMessage(expected, actual));
    }
    ...
    void swapAdjacentNodes() {
        ListNode list1 = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[1 2 3 4]"));
        ListNode list2 = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[1 3 2 4]"));
        InsertionSortList.swapAdjacentNodesAfter(list1);
        assertTrue(ListNode.equals(list1, list2));
    }
    @Test
    void swapAdjacentNodes2() {
        ListNode list1 = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[1 2 3]"));
        ListNode list2 = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[1 3 2]"));
        InsertionSortList.swapAdjacentNodesAfter(list1);
        assertTrue(ListNode.equals(list1, list2));
    }
    @Test
    void swapAdjacentNodes3() {
        ListNode list1 = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[1 2]"));
        ListNode list2 = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[1 2]"));
        InsertionSortList.swapAdjacentNodesAfter(list1);
        assertTrue(ListNode.equals(list1, list2));
    }
    @Test
    void swapAdjacentNodes4() {
        ListNode list1 = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[1]"));
        ListNode list2 = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[1]"));
        InsertionSortList.swapAdjacentNodesAfter(list1);
        assertTrue(ListNode.equals(list1, list2));
    }
    @Test
    void swapAdjacentNodes5() {
        ListNode list1 = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[1 2 3]"));
        ListNode list2 = ListNode.fromList(JavaLists.fromStringWithSpaceSeparatedToList("[2 1 3]"));
